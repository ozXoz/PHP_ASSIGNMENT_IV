...
{   
    ...
    {
        logAction(\Auth::user()->id, 'employees', 'show employee', $request->ip());
    ...
    public function update(Request $request, User $user)
    {
        ...
        $user->cell_number = $request->get('cell_number');
        ...
        $user->save();
        logAction(\Auth::user()->id, 'employees', 'update employee', $request->ip());
    ...
    public function destroy($id, Request $request)
    {
        ...
        logAction(\Auth::user()->id, 'employees', 'delete employee', $request->ip());
