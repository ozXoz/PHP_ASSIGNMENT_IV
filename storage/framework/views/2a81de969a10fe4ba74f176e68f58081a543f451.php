...
<body>
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
        <a href="<?php echo e(route('log-viewer::dashboard')); ?>" class="navbar-brand mr-0">
            <i class="fa fa-fw fa-book"></i> LogViewer
        </a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="<?php echo e(__('Toggle navigation')); ?>">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item <?php echo e(Route::is('log-viewer::dashboard') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('log-viewer::dashboard')); ?>" class="nav-link">
                        <i class="fa fa-dashboard"></i> <?php echo app('translator')->get('Dashboard'); ?>
                    </a>
                </li>
                <li class="nav-item <?php echo e(Route::is('log-viewer::logs.list') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('log-viewer::logs.list')); ?>" class="nav-link">
                        <i class="fa fa-archive"></i> <?php echo app('translator')->get('Logs'); ?>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <footer class="main-footer">
        <div class="container-fluid">
            <p class="text-muted pull-left">
                LogViewer - <span class="badge badge-info">version <?php echo e(log_viewer()->version()); ?></span>
            </p>
...
<?php /**PATH E:\TASK\2021-12-05(php-assign)\laravel-boilerplate-master\vendor\arcanedev\log-viewer\views/bootstrap-4/_master.blade.php ENDPATH**/ ?>