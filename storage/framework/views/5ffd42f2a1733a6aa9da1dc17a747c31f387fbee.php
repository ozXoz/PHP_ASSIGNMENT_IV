<?php $__env->startSection('title',__('views.admin.users.edit.title', ['name' => $notification->name]) ); ?>

<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <?php echo e(Form::open(['route'=>['admin.notifications.update', $notification->id],'method' => 'put','class'=>'form-horizontal form-label-left'])); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" type="text" class="form-control col-md-7 col-xs-12 <?php if($errors->has('name')): ?> parsley-error <?php endif; ?>"
                               name="name" value="<?php echo e($notification->name); ?>" required>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select id="type" name="type" class="select2" style="width: 100%" autocomplete="off">
                            <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($type); ?>" <?php if($type==$notification->type): ?> selected="selected" <?php endif; ?> ><?php echo e($type); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                        ...
                        <div class="checkbox">
                            <label>
                                <input id="status" type="checkbox" class="<?php if($errors->has('status')): ?> parsley-error <?php endif; ?>"
                                       name="status" <?php if($notification->status): ?> checked="checked" <?php endif; ?> value="1">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\TASK\2021-12-05(php-assign)\laravel-proj\resources\views/admin/notifications/edit.blade.php ENDPATH**/ ?>