<?php $__env->startSection('title', 'Create a client event'); ?>

<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <?php echo e(Form::open(['route'=>['admin.client_events.store'],'method' => 'post','class'=>'form-horizontal form-label-left'])); ?>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select id="notification_id" name="notification_id" class="select2" style="width: 100%" autocomplete="off">
                            <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($notification->id); ?>"><?php echo e($notification->name); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/public_html/comp1230/assignments/assignment4/resources/views/admin/client_events/create.blade.php ENDPATH**/ ?>