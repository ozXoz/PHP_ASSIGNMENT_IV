    ...
    <div class="left_col scroll-view">
        ...
        <div class="profile clearfix">
            ...
            <div class="profile_info">
                ...
                <h2><?php echo e(auth()->user()->first_name." ".auth()->user()->last_name); ?></h2>
            </div>
        </div>
        <!-- /menu profile quick info -->
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.client_events')); ?>">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/public_html/comp1230/assignments/assignment4/resources/views/admin/sections/navigation.blade.php ENDPATH**/ ?>