...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <div>
            <h4>How To</h4>
            <ul>
              <li>Manage available membership plans - <a href="https://ui.netlicensing.io/#/modules/LB-DEMO/<?php echo e(config('protection.membership.product_module_number')); ?>/edit" target="_blank"/>NetLicensing Management Console » License Templates</a></li>
              <li>View and manage registered users - <a href="https://ui.netlicensing.io/#/customers?productNumber=<?php echo e(config('protection.product_number')); ?>" target="_blank"/>NetLicensing Management Console » Licensees</a></li>
            </ul>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\TASK\2021-12-05(php-assign)\laravel-boilerplate-master\resources\views/admin/permissions.blade.php ENDPATH**/ ?>